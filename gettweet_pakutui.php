...
$username = "otochanpngn";
$username_2 = "new_boc_you";

$timeline = $connection->get("statuses/user_timeline", array("screen_name" => $username));
$timeline_2 = $connection->get("statuses/user_timeline", array("screen_name" => $username_2));
...
foreach($timeline as $i => $tweet){
	...
	//$tweet_content = mb_convert_encoding($tweet->text, 'UTF-8');
	//$tweet_content = json_encode($tweet->text);
	//echo "$i: $tweet_content" . PHP_EOL;
